  ...
  <div class="mt-6 animate-fade-in" ref="containerRef">
    ...
    >
      ...
      >
        <!-- Card -->
        <div
          class="page-placeholder relative w-full aspect-[1/1.4] rounded-lg overflow-hidden border-2 transition-all duration-200 shadow-sm bg-muted/20"
          :class="[
        ...
        >
          ...
          <button
            @click.stop="openPreview(page.pageNum)"
          ...
          <!-- Selection Overlay -->
          <div
            class="absolute inset-0 transition-colors duration-200 flex items-center justify-center pointer-events-none"
            :class="
              isSelected(page.pageNum)
                ? 'bg-primary/10'
        ...
        <span
          ...
          :class="
            isSelected(page.pageNum) ? 'text-primary' : 'text-muted-foreground'
          "
        >
          {{ page.pageNum }}
        </span>
    ...
    <Teleport to="body">
      <Transition name="fade">
        ...
        >
          <div
            class="relative w-full h-full max-w-7xl flex flex-col items-center justify-center pointer-events-none"
            @click.stop
          >
            ...
            >
              <canvas
                ref="modalCanvas"
                class="max-w-full max-h-full object-contain shadow-2xl rounded-lg bg-white"
              ></canvas>
            </div>
          </div>
        </div>
